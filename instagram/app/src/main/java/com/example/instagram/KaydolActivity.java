                ...
                .addOnCompleteListener(KaydolActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful())
                        {
                            ...
                            hashMap.put("ad", ad);
                            hashMap.put("bio","");
                            hashMap.put("resimurl", "https://firebasestorage.googleapis.com/v0/b/instagram-599e3.appspot.com/o/placeholder.jpeg?alt=media&token=6859f4c9-9dda-4069-80ff-87791a0b1b77");
